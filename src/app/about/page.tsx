  ...
  return (
    <Container as="section" className="max-w-3xl py-10 sm:py-16">
      <header className="border-surface-border border-b pb-6">
        <p className="font-mono-data text-text-secondary text-xs tracking-[0.03em] uppercase">About</p>
      ...
      <div className="mt-8 space-y-10">
        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">The problem</h2>
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
            ...
            years ago sits next to one that&apos;s still live, presented with the exact same confidence.
            Nothing on the page tells you which is which, so you have to click through and find out yourself,
            every time.
          </p>
        </section>

        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">The approach</h2>
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
        ...
        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">
          ...
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
            ...
            program is not the same as being independently reconfirmed against the provider&apos;s live page.
            A newly seeded benefit is marked &quot;needs review&quot; until someone checks the actual current
            offer and confirms it still holds. That&apos;s a deliberate, visible state, not a bug, and not
            something to hide behind a confident-looking green checkmark.
          </p>
        </section>

        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">Who maintains this</h2>
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
        ...
        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">Help keep it accurate</h2>
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
            Know a real student benefit that isn&apos;t listed, or spotted one that&apos;s gone stale? Both
            are useful.{" "}
            <Link
              href="/submit"
              className="text-accent focus-visible:outline-accent rounded-sm hover:underline focus-visible:outline-2 focus-visible:outline-offset-2"
