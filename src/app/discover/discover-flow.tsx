...
export function DiscoverFlow() {
  ...
  if (step === "results") {
    return (
      <div>
        ...
        <div className="mt-6 border-b border-surface-border pb-10" aria-live="polite">
          {resultsLoading ? (
  ...
  if (step === "interests") {
    return (
      <div>
        <p className="font-mono-data text-[11px] tracking-[0.03em] text-text-secondary uppercase">Step 2 of 2</p>
          ...
          {INTERESTS.map((interest) => {
            ...
            return (
              <button
                ...
                className={cx(
                  "font-mono-data rounded-sm border px-3 py-1.5 text-sm tracking-[0.01em] transition-colors duration-150 ease-[var(--ease-standard)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent",
                  active
  ...
  return (
    <div>
      <p className="font-mono-data text-[11px] tracking-[0.03em] text-text-secondary uppercase">Step 1 of 2</p>
      <h2 className="mt-2 text-[28px] leading-[1.15] font-semibold tracking-[-0.01em] text-text-primary">
      ...
      <div className="mt-6 max-w-md">
        ...
        <input
          ...
          className="w-full rounded-md border border-control-border bg-surface px-4 py-3 text-[15px] text-text-primary placeholder:text-text-secondary focus-visible:border-accent focus-visible:outline-none"
        />

        <div className="mt-3 min-h-[1.5rem] font-mono-data text-xs" role="status" aria-live="polite">
          {lookupState === "loading" && (
            <span className="text-text-secondary">Looking that up&hellip;</span>
          )}
          ...
          {lookupState === "error" && (
            <span className="text-status-stale">Couldn&apos;t reach the lookup, but you can still continue.</span>
          )}
        </div>
      </div>
