  ...
  return (
    <Container as="section" className="max-w-3xl py-10 sm:py-16">
      ...
      <div className="mt-8 space-y-10">
        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">What this is</h2>
        ...
        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">Offers can change</h2>
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
            ...
            verified. A verification date tells you when something was last checked, not that it is guaranteed
            to still be accurate today. Always confirm current terms on the provider&apos;s own site before
            relying on an offer.
          </p>
        </section>

        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">Not a party to any transaction</h2>
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
        ...
        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">No affiliation implied</h2>
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
        ...
        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">Submissions</h2>
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
            Anything submitted through the submission form may be reviewed, edited, published, rejected, or
            removed at a maintainer&apos;s discretion. Don&apos;t submit anything you don&apos;t have the
            right to share publicly.
          </p>
        </section>

        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">No warranty</h2>
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
            Perqora is provided as-is, without warranty of any kind, express or implied, including accuracy,
            availability, or fitness for a particular purpose. Use it as a starting point for research, not as
            a final source of truth.
          </p>
        </section>

        <section>
          <h2 className="text-text-primary text-[19px] font-semibold">Changes</h2>
          <p className="text-text-secondary mt-3 max-w-[65ch] text-[16px] leading-[1.6]">
            These terms can change as the project changes. Because the codebase is public, any change to these
            terms is visible in the project&apos;s history.
          </p>
        </section>
      </div>
    </Container>
